...
AccountsTemplates.configureRoute = function (route, options) {
  ...
  var defaultTemplate =
    AccountsTemplates.options.defaultTemplate || "fullPageAtForm";
  ...
  if (layoutType === "blaze") {
    ...
    if (Package["kadira:blaze-layout"]) {
      ...
      throw new Error(
        "useraccounts:flow-routing requires that your project includes kadira:blaze-layout package.",
      );
    }
  ...
  if (layoutType === "blaze-to-react") {
    ...
    if (Package["react-runtime"]) {
      ...
      throw new Error(
        "layoutTemplate is a React element but React runtime package is not found",
      );
    }
    ...
    if (Package["kadira:react-layout"]) {
      ...
      throw new Error(
        "useraccounts:flow-routing requires that your project includes kadira:react-layout package.",
      );
    }
    ...
    if (Package["gwendall:blaze-to-react"]) {
      ...
      throw new Error(
        "useraccounts:flow-routing requires that your project includes the gwendall:blaze-to-react package.",
      );
    }

    layoutRegions[contentRegion] = React.createElement(BlazeToReact, {
      blazeTemplate: template,
    });
  }
