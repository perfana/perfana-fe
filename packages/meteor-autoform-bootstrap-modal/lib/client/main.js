...
Template.afModalWindow.rendered = function () {
  ...
  // use 'static' value.
  modal.data('bs.modal').options.backdrop =
    this.data.backdrop !== undefined ? this.data.backdrop : true;
};
...
Template.afModalWindow.helpers({
  ...
  afterRemove: function () {
    ...
    return function (result) {
      ...
      // noinspection JSMissingSwitchDefault
...
Template.afModalShow.events({
  'click *': function (e, t) {
    ...
    var doc = t.data.doc,
      docId;
    var dialogClass =
      t.data['dialogClass'] !== undefined ? ' ' + t.data['dialogClass'] : '';
    ...
    if (t.data.type !== undefined && t.data.type === 'remove') {
      ...
      return Modal.show('afModalWindow', {
        ...
        buttonContent:
          t.data.buttonContent !== undefined ? t.data.buttonContent : 'Confirm',
        buttonClasses:
          t.data.buttonClasses !== undefined ?
            t.data.buttonClasses
          : 'btn btn-danger',
        closeButtonContent:
          t.data.closeButtonContent !== undefined ?
            t.data.closeButtonContent
          : 'Cancel',
        closeButtonClasses:
          t.data.closeButtonClasses !== undefined ?
            t.data.closeButtonClasses
          : 'btn',
    ...
    if (
      t.data.meteormethod !== undefined &&
      (t.data.type === 'method' || t.data.type == 'method-update')
    ) {
    ...
    if (
      t.data.labelClass !== undefined ||
      t.data['label-class'] !== undefined
    ) {
      afAtts['label-class'] = t.data.labelClass || t.data['label-class'];
    }
    if (
      t.data.inputColClass !== undefined ||
      t.data['input-col-class'] !== undefined
    ) {
      afAtts['input-col-class'] =
        t.data.inputColClass || t.data['input-col-class'];
    }
