...
AT.prototype.atResendVerificationEmailLinkHelpers = {
  ...
  preText: function () {
    return T9n.get(
      AccountsTemplates.texts.resendVerificationEmailLink_pre,
      (markIfMissing = false),
    );
  },
  linkText: function () {
    return T9n.get(
      AccountsTemplates.texts.resendVerificationEmailLink_link,
      (markIfMissing = false),
    );
  },
  suffText: function () {
    return T9n.get(
      AccountsTemplates.texts.resendVerificationEmailLink_suff,
      (markIfMissing = false),
    );
  },
};
