...
Tinytest.add("AccountsTemplates - addField/removeField", function (test) {
  ...
  test.throws(
    ...
    function (err) {
      if (
        err instanceof Error &&
        err.message == "A field called foo does not exist!"
      )
        return true;
    },
  );
  ...
  test.throws(
    ...
    function (err) {
      if (
        err instanceof Error &&
        err.message == "A field called password already exists!"
      )
        return true;
    },
  );
  ...
  test.throws(
    ...
    function (err) {
      if (
        err instanceof Error &&
        err.message == "field.minLength should be greater than zero!"
      )
        return true;
    },
  );
  ...
  test.throws(
    ...
    function (err) {
      if (
        err instanceof Error &&
        err.message == "field.maxLength should be greater than zero!"
      )
        return true;
    },
  );
  ...
  test.throws(
    ...
    function (err) {
      if (
        err instanceof Error &&
        err.message == "field.maxLength should be greater than field.maxLength!"
      )
        return true;
    },
  );
