...
import './testRunCompareResultsBaselineTestRun.html';
...
Template.testRunCompareResultsBaselineTestRun.onCreated(
  function testRunCompareResultsBaselineTestRunOnCreated() {
    ...
    this.autorun(() => {
      if (
        ...
        Meteor.subscribe(
          'checkResults',
          query,
          'testRunCompareResultsBaselineTestRun',
        );
      ...
      let fixedBaselineTestRunCompareResults;
      ...
      if (testRun) {
        /* fixed baseline test run */

        const baselineTestRunId = getFixedBaselineTestRun(testRun);

        if (baselineTestRunId) {
          fixedBaselineTestRunCompareResults = CompareResults.find({
            $and: [
        ...
        if (fixedBaselineTestRunCompareResults !== undefined) {
          fixedBaselineTestRunCompareResults.forEach((compareResult) => {
            ...
            if (applicationDashboard) {
              ...
              panel.fixedBaselineTestRunCompareCheck.baselineTestRunId =
              ...
              panel.fixedBaselineTestRunCompareCheck.baselineSnapshotPanelUrl =
                compareResult.baselineSnapshotPanelUrl;
              panel.fixedBaselineTestRunCompareCheck.label =
                compareResult.label;
              panel.fixedBaselineTestRunCompareCheck.status =
                compareResult.status;
              panel.fixedBaselineTestRunCompareCheck.message =
                compareResult.message;
              panel.fixedBaselineTestRunCompareCheck.panelAverage =
                compareResult.panelAverage;
              panel.fixedBaselineTestRunCompareCheck.benchmarkBaselineTestRunPanelAverage =
                compareResult.benchmarkBaselineTestRunPanelAverage;
              panel.fixedBaselineTestRunCompareCheck.benchmarkBaselineTestRunPanelAverageDelta =
                compareResult.benchmarkBaselineTestRunPanelAverageDelta;
              panel.fixedBaselineTestRunCompareCheck.benchmarkBaselineTestRunPanelAverageDeltaPct =
                compareResult.benchmarkBaselineTestRunPanelAverageDeltaPct;
              panel.fixedBaselineTestRunCompareCheck.targets =
                compareResult.targets;

              if (
                panel.fixedBaselineTestRunCompareCheck
                  .benchmarkBaselineTestRunOK === false
              ) {
...
Template.testRunCompareResultsBaselineTestRun.helpers({
  baselineTestRunLink() {
    const testRun = getTestRun(
      FlowRouter.current().queryParams.systemUnderTest,
      FlowRouter.current().params.testRunId,
      ...
      const failedChecks = Template.instance()
        ...
        .filter((panel) => {
          return (
            panel.fixedBaselineTestRunCompareCheck &&
            panel.fixedBaselineTestRunCompareCheck
              .benchmarkBaselineTestRunOK !== undefined &&
            panel.fixedBaselineTestRunCompareCheck
              .benchmarkBaselineTestRunOK === false
          );
        })
...
Template.testRunCompareResultsBaselineTestRun.events({
...
Template.testRunCompareResultsBaselineTestRunAccordion.onCreated(
  function testRunCompareResultsBaselineTestRunAccordion() {
...
Template.testRunCompareResultsBaselineTestRunAccordion.onRendered(
  function testRunCompareResultsBaselineTestRunOnRendered() {
    // Meteor.setTimeout(() => {
    //
...
Template.testRunCompareResultsBaselineTestRunAccordion.helpers({
...
Template.testRunCompareResultsBaselineTestRunAccordion.events({
...
Template.testRunCompareResultsBaselineTestRunDetails.onRendered(
...
Template.testRunCompareResultsBaselineTestRunDetails.helpers({
  hasSnapshotPanelUrl() {
    return (
